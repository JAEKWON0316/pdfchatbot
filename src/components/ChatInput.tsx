  ...
  return (
    <div className="flex-none w-full bg-white/80 px-2 py-4 shadow-inner z-20 flex flex-col items-center">
      <form className="w-full max-w-3xl flex gap-2" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className={`px-5 py-3 rounded-2xl font-bold shadow-lg flex items-center gap-2 transition-all duration-150
        ...
        >
          {isLoading ? (
            <LoaderCircle className="animate-spin text-2xl text-blue-300" />
          ) : (
